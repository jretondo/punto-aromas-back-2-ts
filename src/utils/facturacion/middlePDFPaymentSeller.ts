      ...
      try {
        ...
        const totales = {
          ...
          subTotalNoFiscal: formatMoney(
            Math.abs(newFact.total_neto) + Math.abs(newFact.total_iva) + Math.abs(newFact.descuento)
          ),
        ...
        switch (newFact.forma_pago) {
          ...
          case 2: formapagoStr = 'DÉBITO'; break;
          case 3: formapagoStr = 'CRÉDITO'; break;
          case 4: formapagoStr = 'CUENTA CORRIENTE'; break;
          default: formapagoStr = 'VARIOS'; break;
        }
